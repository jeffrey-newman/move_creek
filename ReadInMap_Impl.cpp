...
template
std::tuple<Map_Int_SPtr, std::string, GeoTransform>  read_in_map(fs::path file_path, GDALDataType data_type);

template
std::tuple<Map_Double_SPtr, std::string, GeoTransform>  read_in_map(fs::path file_path, GDALDataType data_type);
